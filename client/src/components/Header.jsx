    ...
    return (
        <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
            ...
            <div>
                ...
                <p className='my-6 text-[15px] text-gray-500'>Easily remove backgrounds from your images with just one click. No design   <br className='max-sm:hidden' />skills needed — fast, accurate, and completely free to use.Perfect for creating<br/>  transparent images for presentations, e-commerce, and social media.</p>
                <div>
